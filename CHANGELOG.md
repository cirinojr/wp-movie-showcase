...
All notable changes to WP Movie Showcase are documented here.

## 1.0.0 - 2026-08-19

- Added a dynamic Gutenberg movie-search block with accessible autocomplete.
- Added server-side OMDb integration with validated and normalized responses.
- Added request-local caching and persistent object-cache or Transients backends.
